...
namespace WolfEngine{
	class WOLFORCE_API Audio: public Component{
	public: 
		virtual void setPlayOnceMode(bool) = 0;
		virtual void setLoopingStreamMode() = 0;
		virtual void setRandomMode(int,int) = 0;
		virtual void setSoundFileName(const char*) = 0;
		virtual const char* getSoundFileName() const = 0;
		virtual void setMinMaxSoundDistance(float,float) = 0;
		virtual void stop() = 0;
	};
}
#endif