...
{
class IRRWOLFORCE_API IrrKlangSceneNode : public scene::ISceneNode, public Audio
{
public:

	IrrKlangSceneNode(irrklang::ISoundEngine* soundEngine,
...
class IrrKlangSceneNodeFactory : public ISceneNodeFactory
{
public:

	IrrKlangSceneNodeFactory(irrklang::ISoundEngine* soundEngine, ISceneManager* mgr);
	~IrrKlangSceneNodeFactory();
